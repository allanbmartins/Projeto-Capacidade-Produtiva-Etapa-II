...
a <- ggplot ()+
  geom_point(col="blue", fill = "black", size = 2,label = TRUE, show.legend = TRUE,aes(x= bd_temp$mod2_eff,y = bd_temp$mod3_eff))+
  geom_text(
    data = bd_temp,
    aes(
      x= mod2_eff,
...
graf_bar_vert_mod(bd_graf_disp_mod_percent,titulo_graf_disp[1],titulo_graf_disp_mod[1])
...
#Gráfico de dispersão - 2° Modelo 4 x Modelo 3
 graf_disp_mod <- function(bd_temp,bd_temp2,bd_temp3,bd_temp4,bd_temp5){
a <- ggplot ()+
  geom_point(col="blue", fill = "black", size = 2,label = TRUE, show.legend = TRUE,aes(x= bd_temp$mod3_eff,y = bd_temp$mod4_eff))+
  geom_text(
    data = bd_temp,
    aes(
      x= mod3_eff,
...
#Gráfico de dispersão - 3° Modelo 5 × Modelo 4
 graf_disp_mod <- function(bd_temp,bd_temp2,bd_temp3,bd_temp4,bd_temp5){
a <- ggplot ()+
  geom_point(col="blue", fill = "black", size = 2,label = TRUE, show.legend = TRUE,aes(x= bd_temp$mod4_eff,y = bd_temp$mod5_eff))+
  geom_text(
    data = bd_temp,
    aes(
      x= mod4_eff,
