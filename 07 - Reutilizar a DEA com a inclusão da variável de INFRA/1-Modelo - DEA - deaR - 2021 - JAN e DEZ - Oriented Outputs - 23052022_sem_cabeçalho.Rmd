...
titulo_graf_eff <- c("Percentual de aumento na capacidade de produção - Modelo 1","Percentual de aumento na capacidade de produção - Modelo 2","Percentual de aumento na capacidade de produção - Modelo 3","Percentual de aumento na capacidade de produção - Modelo 4","Percentual de aumento na capacidade de produção - Modelo 5","Percentual de aumento na capacidade de produção - Modelo 6")

titulo_mapa_modelo <- c("Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 1","Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 2","Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 3","Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 4","Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 5","Mapa Brasil do Percentual de aumento na capacidade de produção - Modelo 6")
```
...
bd_m_dea_12_2021 <- read_excel("bd_zy_zf_zs_2021_trab_v5_sem_ap.xlsx", sheet=1, col_names=TRUE)
...
O modelo orientado a saída (output)  maximiza as saídas, enquanto a entrada é mantida em nível constante. 

No contexto da Rede, os resultados O-O apontaråo quanto o OD poderia produzir, considerando os mesmos recursos atuais (FT, Custeio e Infra).
...
result_dea_eff$eff <- ifelse (result_dea_eff$eff < 1.0,  (result_dea_eff$eff = 0.0000),(result_dea_eff$eff - 1.000))
...
x_temp <- 
  x_temp %>% 
  mutate(eficiencia = case_when(eff <= 1.0000 ~ "A - até 1x aumento capacidade",
                                 (eff <= 2.000) & (eff > 1.0000) ~ "B - até 2x de aumento capacidade",
                                 eff > 2.0000 ~ "C - até 5x de aumento capacidade"))
return(x_temp)
}
...
### Mapa Brasil {.tabset .tabset-fade .tabset-pills}
...
result_dea_eff_mod3$eff <- ifelse (result_dea_eff_mod3$eff < 1.0, (result_dea_eff_mod3$eff = 0.0000), (result_dea_eff_mod3$eff - 1.0000))
...
result_dea_eff_mod4$eff <- ifelse (result_dea_eff_mod4$eff < 1.0, (result_dea_eff_mod4$eff = 0.0000), (result_dea_eff_mod4$eff - 1.0000))
...
result_dea_eff_mod5$eff <- ifelse (result_dea_eff_mod5$eff < 1.0, (result_dea_eff_mod5$eff = 0.0000), (result_dea_eff_mod5$eff - 1.0000))
